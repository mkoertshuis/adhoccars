...
float get_distance_to_leader() {
  ...
  float leader_to_ap = 1*powf(10, ((measured_power - (float) rssi_leader_val) / ( 10 * env_val)));
  float follower_to_ap = 1*powf(10, ((measured_power - (float) rssi_self_val) / ( 10 * env_val)));
